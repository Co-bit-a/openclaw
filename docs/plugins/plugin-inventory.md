...
- **[companion](/plugins/reference/companion)** (`@openclaw/companion`) - included in OpenClaw. Local personal-assistant utilities for understanding and managing work across projects.
