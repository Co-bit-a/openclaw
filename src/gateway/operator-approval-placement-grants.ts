...
import type { PluginApprovalPlacementGrantBinding } from "../infra/plugin-approvals.js";
...
export type PlacementStandingGrantMintSpec = PluginApprovalPlacementGrantBinding;
...
type PlacementGrantResolutionInput = Pick<
  ...
  "pluginId" | "command" | "riskFamily" | "agentId" | "sessionKey" | "nodeId" | "pairingGeneration"
>;
...
export function mintPlacementStandingGrantLocked(
  ...
  executeSqliteQuerySync(
    ...
    stateDb
      ...
      .where("risk_family", "=", params.riskFamily)
