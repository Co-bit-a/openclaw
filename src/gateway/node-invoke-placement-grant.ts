...
export type NodeInvokePlacementGrantAuthorization = {
  binding?: PluginApprovalPlacementGrantBinding;
};
...
type PlacementGrantResolution =
  ...
  | {
      kind: "prompt";
      binding: PluginApprovalPlacementGrantBinding | null;
...
export type NodeInvokePlacementGrantOwner = {
  agentId: string;
  sessionKey: string;
  assertCurrent: (binding: PluginApprovalPlacementGrantBinding) => void;
};
